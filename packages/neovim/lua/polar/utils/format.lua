...
function M.format(opts)
    ...
    --     -- TODO LazyVim.warn("No formatter available", { title = "LazyVim" })
    -- end
end
...
function M.snacks_toggle(buf)
    return Snacks.toggle({
        ...
        get = function()
            ...
            return require("polar.utils.format").enabled()
        end,
        set = function(state)
            require("polar.utils.format").enable(state, buf)
        end,
    })
end
